          ...
          <nav class="u-pull-right">
            <ul>
              ...
              <li class="has-submenu"><a href="#">Misurazioni</a>
                <ul>
                  <li><a href="/measure">Lista</a></li>
                  <li><a href="measure-value">Gestione</a></li>
                </ul>
              </li>
              <li class="has-submenu"><a href="#">Muscoli</a>
                <ul>
                  <li><a href="/muscle">Lista</a></li>
                  <li><a href="/muscle-worked">Associa</a></li>
                </ul>
              </li>
              <li><a href="/training-method">Modelli d'Allenamento</a></li>
            </ul>
          </nav>
        </div>
      </div>
